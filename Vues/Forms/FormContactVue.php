...
<div>
    ...
    <form action="?action=CreateContact" method="POST" onsubmit="return checkValueContact()"> <!--enctype="multipart/form-data" uniquement pour l'upload de fichier-->
        <div class="container">
            ...
            <div class="containerForm">
                <div class="comps">
                    <p>(Attention la nationalité doit être similaire au pays de la mission en cours)</p>
                    <p id="MissionValue">Pays de la mission : <?php echo $missions[4]; ?></p>
                    <div>
                        <label for="nationality">Nationalité</label>
                    </div>
                    <div>
                        <select name="nationality" id="nationalities" required>
